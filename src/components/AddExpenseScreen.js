...
const API_URL = 'http://192.168.234.250:5000/projects'; // Update with your backend URL
const FETCH_ID_URL = 'http://192.168.234.250:5000/get_project_payment_details'; // Replace with actual endpoint
const ADD_EXPENSE_URL = 'http://192.168.234.250:5000/add_expense';
...
const AddExpenseScreen = () => {
  ...
  const fetchPickerOptions = async (category) => {
    try {
      ...
      const response = await axios.get(`http://192.168.234.250:5000/${category}`);
